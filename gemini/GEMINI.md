...
- All inputs are local under `input/`. Never connect to Fabric, a gateway, Power BI Service, a database, or any network data source. Do not use MCP servers or web search.
