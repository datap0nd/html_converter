...
<div class="status" id="report-status">${noData ? 'PBIP metadata only: no readable CSV/JSON data found. Values and charts cannot be verified.' : rawSource ? 'Direct CSV source read. Rows are raw; Power Query transformations and DAX results are not automatically reproduced.' : 'Local data supplied. Visual calculations and fidelity still require review.'}</div>
