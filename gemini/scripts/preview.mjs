...
<div class="status" id="report-status">${noData ? 'PBIP metadata only: no local data export supplied. Values and charts cannot be verified.' : 'Local data supplied. Visual calculations and fidelity still require review.'}</div>
